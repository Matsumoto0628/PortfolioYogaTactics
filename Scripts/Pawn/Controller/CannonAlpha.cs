...
namespace CannonAlpha
{
    ...
    public class Attack : IState<State, CannonAlphaController>
    {
        public State State => State.Attack;

        public void Enter(CannonAlphaController pawn)
        {
        ...
        public void Update(CannonAlphaController pawn)
        {
            
        }

        public void Exit(CannonAlphaController pawn)
        {

        }

        public IEnumerator ShootCoroutine(CannonAlphaController pawn, Action onComplete)
        {
        ...
        private void Shoot(CannonAlphaController pawn)
        {
    ...
    public class Move : IState<State, CannonAlphaController>
    {
        public State State => State.Move;
        private const float RANGE_ATTACK = 4f;
        private const float SPAN_ATTACK = 1.5f;
...
public class CannonAlphaController : PawnController
{
    private FSM<State, CannonAlphaController> fsm;
    public FSM<State, CannonAlphaController> FSM => fsm;
    ...
    public CannonAlphaController(GameObject self) : base(self) { }

    public override void SetupFSM()
    {
        fsm = new FSM<State, CannonAlphaController>(this, new IState<State, CannonAlphaController>[]
        {
            new Attack(),
            new Move()
        });
